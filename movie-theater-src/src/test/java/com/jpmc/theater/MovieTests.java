...
public class MovieTests {
    ...
    void specialMovieWith20PercentDiscount() {
        ...
        assertEquals(10.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void normalMovie1stDayDiscountWith3Dollar() {
        ...
        assertEquals(7.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void normalMovie2ndDayDiscountWith2Dollar() {
        ...
        assertEquals(8.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void normalMovieStart11AMWith25PercentDiscount() {
        ...
        assertEquals(7.50, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void normalMovieShowOn7thWith1DollarDiscount() {
        ...
        assertEquals(9.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void specialMovie100WithMaxDiscount25PercentDiscount() {
        ...
        assertEquals(75.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
    ...
    void specialMovieDiscountIsGreaterThanPrice() {
        ...
        assertEquals(0.00, showing.getMovieFee().setScale(2, RoundingMode.HALF_UP).doubleValue());
    }
}
