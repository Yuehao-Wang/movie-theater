...
public class TheaterTests {
    ...
    void totalFeeForCustomer() {
        ...
        // one ticket is 9.375, because the showing starts between 11AM ~ 4pm, you'll get 25% discount
        assertEquals(37.50, reservation.getTotalFee());
    }

    @Test
    void printMovieSchedule() {
        Theater theater = new Theater(LocalDateProvider.singleton());
        String jsonSchedule = theater.printSchedule();
